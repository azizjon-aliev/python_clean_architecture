...
from src.application.presenters.currency_presenter import ListCurrencyPresenter, CreateCurrencyPresenter, \
    UpdateCurrencyPresenter
from src.infrastructure.repotisories.currency_repository import CurrencyRepository
from src.interactor.dtos.currency_dtos import ListCurrencyInputDto, CreateCurrencyInputDto, UpdateCurrencyInputDto
from src.interactor.interfaces.logger.logger import LoggerInterface
from src.interactor.use_cases.currency import ListCurrencyUseCase, CreateCurrencyUseCase, UpdateCurrencyUseCase, \
...
def test_list_currency_use_case():
    ...
    assert all([isinstance(currency, CurrencyEntity) for currency in response.get('currencies')])
